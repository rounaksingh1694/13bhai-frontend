...
import "../../css/navigation/Bottombar.css";
		...
		<div className="bottombar">
			<div class="bottombar-tabs">
				<div
					class={
						selected === 0
							? "bottombar-tab bottombar-tab-selected"
							: "bottombar-tab"
					}
					onClick={() => {
						setSelected(0);
				...
				>
					...
					<div
						class={
							selected === 0 ? "bottombar-text-selected" : "bottombar-text"
						}
					>
						Courses
					</div>
				...
				>
					...
					<div
						class={
							selected === 1 ? "bottombar-text-selected" : "bottombar-text"
						}
					>
						Jobs
					</div>
				...
				>
					...
					>
						<path
							...
							fill={selected == 2 ? "#9A76FF" : "#CECECE"}
						/>
					</svg>
					<div
						class={
							selected === 2 ? "bottombar-text-selected" : "bottombar-text"
						}
					>
						Hackathons
					</div>
